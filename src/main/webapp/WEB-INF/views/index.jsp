...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="container">
       ...
       <div class="row no-gutters site-navbar align-items-center py-3">
        ...
        <div class="col-6 col-lg-2 site-logo">
          <a href="index.html">Runner's High</a>
        </div>
        <div class="col-6 col-lg-10 text-right menu">
          <nav class="site-navigation text-right text-md-right">
              ...
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="gallery.html">대회일정</a></li>
                <li><a href="events.html">챌린지</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="hero-wrap" style="background-image: url('../static/images/hero_1.jpg');" data-stellar-background-ratio="0.5">
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="col-md-12 col-lg-12 mb-12 mb-lg-12">
              <div class="custom-media d-flex">
                ...
                <div>
                  ...
                  <h2><a href="#">국내 마라톤 / 걷기 대회 일정 전체 조회가 가능한 페이지입니다</a></h2>
                  <h1 class="mb-0"><a href="#" class="more"><span class="mr-2">+</span>GO</a></h1>
                </div>
              </div>
            </div>
            <div class="col-md-12 col-lg-12 mb-12 mb-lg-12" style="padding: 30px 0px 0px 0px">
              <div class="custom-media d-flex" >
                 <div style="text-align: right">
                  <span class="caption">챌린지</span>
                  <h2><a href="#">다양한 러닝 챌린지를 구상하고 모집할 수 있는 페이지입니다</a></h2>
                  <h1 class="mb-0"><a href="#" class="more"><span class="mr-2">+</span>GO</a></h1>
                </div>
      ...
      <div class="container">
        ...
        <div class="owl-4-slider owl-carousel">
          <div class="item player">
            <a href="#"><img src="../static/images/player_4.jpg" alt="Image" class="img-fluid"></a>
            <div class="p-4">
              <h3>Jakub Bates</h3>
              <p>#10 / Forward</p>
            </div>
          ...
          <div class="item player">
            <a href="#"><img src="../static/images/player_1.jpg" alt="Image" class="img-fluid"></a>
            <div class="p-4">
          ...
          <div class="item player">
            <a href="#"><img src="../static/images/player_5.jpg" alt="Image" class="img-fluid"></a>
            <div class="p-4">
              <h3>Russell Vance</h3>
              <p>#1 / Goal Keeper</p>
            </div>
          ...
          <div class="item player">
            <a href="#"><img src="../static/images/player_3.jpg" alt="Image" class="img-fluid"></a>
            <div class="p-4">
          ...
          <div class="item player">
            <a href="#"><img src="../static/images/player_2.jpg" alt="Image" class="img-fluid"></a>
            <div class="p-4">
              <h3>Russell Vance</h3>
              <p>#6 / Forward</p>
            </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_1.jpg" data-fancybox="gal"><img src="../static/images/img_1.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_2.jpg" data-fancybox="gal"><img src="../static/images/img_2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_3.jpg" data-fancybox="gal"><img src="../static/images/img_3.jpg" alt="Image" class="img-fluid"></a>
          </div>

          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_4.jpg" data-fancybox="gal"><img src="../static/images/img_4.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_5.jpg" data-fancybox="gal"><img src="../static/images/img_5.jpg" alt="Image" class="img-fluid"></a>
          </div>/static
          <div class="col-6 col-sm-6 col-md-4 col-lg-3 mb-4">
            <a href="images/img_1.jpg" data-fancybox="gal"><img src="../static/images/img_1.jpg" alt="Image" class="img-fluid"></a>
          </div>
