...
<form name= "regist_form" method="post" action="/regist">
    <div class="container">
        ...
        <div class="form-group">
        	...
        	<p></p>
       		<button type="button" class="btn btn-primary" onclick="change_btn(event)">대회용</button>
       		<button type="button" class="btn btn-primary" onclick="change_btn(event)">일상용</button>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
        	...
        	<p></p>
        	<div id="buttons">
       			<button type="button" class="btn btn-primary" onclick="change_btn(event);">모집중</button>
       			<button type="button" class="btn btn-primary" onclick="change_btn(event);">모집종료</button>
       			<button type="button" class="btn btn-primary" onclick="change_btn(event);">모집예정</button>
       		</div>
		</div>
		<div class="form-group">
        	<label for="chall_category">온라인/오프라인 여부</label>
        	<p></p>
       		<button type="button" class="btn btn-primary" onclick="change_btn(event);">온라인</button>
       		<button type="button" class="btn btn-primary" onclick="change_btn(event);">오프라인</button>
       		<button type="button" class="btn btn-primary" onclick="change_btn(event);">모두</button>
		</div>
		<div class="form-group">
